...
@ControllerAdvice
public class HandlerHouseException {
    ...
    protected ResponseEntity<ErrorDTO> handleValidationStatusExceptions(HttpMessageNotReadableException e) {
        ErrorDTO error = new ErrorDTO("HttpMessageNotReadableException", e.getMessage());
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(TuCasitaException.class)
    public ResponseEntity<ErrorDTO> tuCasitaException(TuCasitaException e){
